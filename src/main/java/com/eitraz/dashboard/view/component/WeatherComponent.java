...
@SpringComponent
@UIScope
public class WeatherComponent extends HorizontalLayout {
    private static final Logger logger = LoggerFactory.getLogger(WeatherComponent.class);
    ...
    @Autowired
    public WeatherComponent(DarkSkyService darkSky) {
